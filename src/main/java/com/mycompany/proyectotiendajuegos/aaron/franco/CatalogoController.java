...
public class CatalogoController implements Initializable {
    ...
    private void configurarColumnas() {
        ...
        colMedia.setCellValueFactory(c -> {double m = gd.getPuntuacionMediaJuego(c.getValue().getIdJuego());return new SimpleStringProperty(m > 0 ? String.format("%.1f", m) : "–");});
        ...
        // Colorea la columna Stock según nivel
    ...
    private void mostrarDetalle(Juego j) {
        ...
        lblDetDirector.setText(j.getDirector()); double m = gd.getPuntuacionMediaJuego(j.getIdJuego());
    ...
    public void comprarSeleccionado() {
        ...
        if ("OK".equals(resultado)) {DialogUtil.info("¡Compra realizada! " + j.getTitulo() + " añadido a tu biblioteca.");cargarTodos();
