...
public class EstadisticasAdminController implements Initializable {
    ...
    private void inicializarResJuego() {
        ...
        tablaResJuego.getSelectionModel().selectedItemProperty().addListener((obs, ant, j) -> {
            if (j == null) {
                tablaResDetJuego.getItems().clear();
                return;
            }
    ...
    private void inicializarResUsuario() {
        ...
        tablaResUsuario.getSelectionModel().selectedItemProperty().addListener((obs, ant, u) -> {
            if (u == null) {
                tablaResDetUsuario.getItems().clear();
                return;
            }
    ...
    private void inicializarResIdioma() {
        ...
        tablaResIdioma.getSelectionModel().selectedItemProperty().addListener((obs, ant, idioma) -> {
            if (idioma == null) {
                tablaResDetIdioma.getItems().clear();
                return;
            }
    ...
    private void inicializarJuegosUsuario() {
        ...
        colJUTotal.setCellValueFactory(c -> new SimpleStringProperty(
                String.valueOf(gd.getBibliotecaUsuario(c.getValue().getIdUsuario()).size())));
        ...
        tablaJuegosUsuario.getSelectionModel().selectedItemProperty().addListener((obs, ant, u) -> {
            if (u == null) {
                tablaJuegosDetUsuario.getItems().clear();
                return;
            }
